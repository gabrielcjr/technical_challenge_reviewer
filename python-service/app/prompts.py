...
def build_fallback_prompt(challenge_text: str, file_tree: str) -> str:
    """Simpler prompt if file contents too large or missing"""
    return f"""
...
Based on file structure and names, does this look like it could meet requirements? Be lenient but check for obvious missing parts.
